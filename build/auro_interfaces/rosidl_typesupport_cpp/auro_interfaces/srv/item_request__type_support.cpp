...
static const _ItemRequest_Request_type_support_symbol_names_t _ItemRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auro_interfaces, srv, ItemRequest_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auro_interfaces, srv, ItemRequest_Request)),
  }
};
...
{
  return &::auro_interfaces::srv::rosidl_typesupport_cpp::ItemRequest_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auro_interfaces, srv, ItemRequest_Request)() {
  return get_message_type_support_handle<auro_interfaces::srv::ItemRequest_Request>();
}
...
static const _ItemRequest_Response_type_support_symbol_names_t _ItemRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auro_interfaces, srv, ItemRequest_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auro_interfaces, srv, ItemRequest_Response)),
  }
};
...
{
  return &::auro_interfaces::srv::rosidl_typesupport_cpp::ItemRequest_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auro_interfaces, srv, ItemRequest_Response)() {
  return get_message_type_support_handle<auro_interfaces::srv::ItemRequest_Response>();
}
...
static const _ItemRequest_type_support_symbol_names_t _ItemRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auro_interfaces, srv, ItemRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auro_interfaces, srv, ItemRequest)),
  }
};
...
{
  return &::auro_interfaces::srv::rosidl_typesupport_cpp::ItemRequest_service_type_support_handle;
}
