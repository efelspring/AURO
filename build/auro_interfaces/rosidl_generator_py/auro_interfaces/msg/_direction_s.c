...
bool auro_interfaces__msg__direction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auro_interfaces.msg._direction.Direction", full_classname_dest, 40) == 0);
  }
  auro_interfaces__msg__Direction * ros_message = _ros_message;
  {  // direction
...
PyObject * auro_interfaces__msg__direction__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("auro_interfaces.msg._direction");
