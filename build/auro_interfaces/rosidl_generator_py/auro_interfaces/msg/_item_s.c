...
bool auro_interfaces__msg__item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auro_interfaces.msg._item.Item", full_classname_dest, 30) == 0);
  }
  auro_interfaces__msg__Item * ros_message = _ros_message;
  {  // x
...
PyObject * auro_interfaces__msg__item__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("auro_interfaces.msg._item");
