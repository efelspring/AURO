...
#include "auro_interfaces/msg/detail/item__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auro_interfaces::msg::Item & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auro_interfaces::msg::Item & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auro_interfaces::msg::Item;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auro_interfaces::msg::Item *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auro_interfaces::msg::Item *>(
    untyped_ros_message);
...
{
  return &auro_interfaces::msg::typesupport_fastrtps_cpp::_Item__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auro_interfaces, msg, Item)() {
  return &auro_interfaces::msg::typesupport_fastrtps_cpp::_Item__handle;
}
