...
{
  new (message_memory) auro_interfaces::msg::ItemList(_init);
}

void ItemList_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auro_interfaces::msg::ItemList *>(message_memory);
  typed_message->~ItemList();
}

size_t size_function__ItemList__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<auro_interfaces::msg::Item> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<auro_interfaces::msg::Item> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<auro_interfaces::msg::Item> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const auro_interfaces::msg::Item *>(
    get_const_function__ItemList__data(untyped_member, index));
  auto & value = *reinterpret_cast<auro_interfaces::msg::Item *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<auro_interfaces::msg::Item *>(
    get_function__ItemList__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const auro_interfaces::msg::Item *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ItemList_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<auro_interfaces::msg::Item>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(auro_interfaces::msg::ItemList, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ItemList_message_members = {
  ...
  1,  // number of fields
  sizeof(auro_interfaces::msg::ItemList),
...
{
  return &::auro_interfaces::msg::rosidl_typesupport_introspection_cpp::ItemList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auro_interfaces, msg, ItemList)() {
  return &::auro_interfaces::msg::rosidl_typesupport_introspection_cpp::ItemList_message_type_support_handle;
}
