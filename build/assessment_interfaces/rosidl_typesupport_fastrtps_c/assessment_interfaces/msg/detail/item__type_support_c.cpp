...
#include "assessment_interfaces/msg/detail/item__rosidl_typesupport_fastrtps_c.h"
...
using _Item__ros_msg_type = assessment_interfaces__msg__Item;
...
static uint32_t _Item__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_assessment_interfaces__msg__Item(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = assessment_interfaces__msg__Item;
    is_plain =
      (
...
static size_t _Item__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_assessment_interfaces__msg__Item(
