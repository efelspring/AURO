...
static const _ZoneList_type_support_symbol_names_t _ZoneList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assessment_interfaces, msg, ZoneList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assessment_interfaces, msg, ZoneList)),
  }
};
...
{
  return &::assessment_interfaces::msg::rosidl_typesupport_cpp::ZoneList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assessment_interfaces, msg, ZoneList)() {
  return get_message_type_support_handle<assessment_interfaces::msg::ZoneList>();
}
