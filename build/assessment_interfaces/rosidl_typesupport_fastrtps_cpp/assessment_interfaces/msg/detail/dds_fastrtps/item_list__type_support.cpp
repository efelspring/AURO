...
#include "assessment_interfaces/msg/detail/item_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const assessment_interfaces::msg::ItemList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  assessment_interfaces::msg::ItemList & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = assessment_interfaces::msg::ItemList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const assessment_interfaces::msg::ItemList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<assessment_interfaces::msg::ItemList *>(
    untyped_ros_message);
...
{
  return &assessment_interfaces::msg::typesupport_fastrtps_cpp::_ItemList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assessment_interfaces, msg, ItemList)() {
  return &assessment_interfaces::msg::typesupport_fastrtps_cpp::_ItemList__handle;
}
