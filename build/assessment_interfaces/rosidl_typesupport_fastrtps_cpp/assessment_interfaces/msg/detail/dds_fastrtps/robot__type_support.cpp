...
#include "assessment_interfaces/msg/detail/robot__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const assessment_interfaces::msg::Robot & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  assessment_interfaces::msg::Robot & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = assessment_interfaces::msg::Robot;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const assessment_interfaces::msg::Robot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<assessment_interfaces::msg::Robot *>(
    untyped_ros_message);
...
{
  return &assessment_interfaces::msg::typesupport_fastrtps_cpp::_Robot__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assessment_interfaces, msg, Robot)() {
  return &assessment_interfaces::msg::typesupport_fastrtps_cpp::_Robot__handle;
}
